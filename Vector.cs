...
public class Vector
{
    ...
    {
        return MathF.Sqrt(MathF.Pow(m_x - other.m_x, 2) + MathF.Pow(m_y - other.m_y, 2) +
                          MathF.Pow(m_z - other.m_z, 2));
    }
    ...
    {
        return MathF.Sqrt(MathF.Pow(m_x, 2f) + MathF.Pow(m_y, 2f) + MathF.Pow(m_z, 2f));
    }
